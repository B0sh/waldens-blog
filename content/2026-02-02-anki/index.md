+++
title = "Anki Partnership Announcement"
date = 2026-02-02
...
Last month, I walked a friend of mine learning English on how to use Anki, and it took me over an hour to go through all of the different tools and addons that I use to set the whole system up. She seemed really happy with it in the end, but I left that experience reminded my first time with Anki and how many different guides I had to comb through to settle into learning. Maybe there's some way to better integrate the wealth of 3rd part addons into a more seamless experience. As a developer, I wrote HTML to style my flash cards, [scripts](/coding-for-japanese/) to automate new flash cards, and [created PRs](https://github.com/DillonWall/generate-batch-audio-anki-addon/pull/7) to improve the addons I was use. It was dare I say perfect for me, but I also want regular users have that feeling of freedom too. Anki is so great *because* you have so much power to control your own learning. 
